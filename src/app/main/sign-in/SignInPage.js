...
import GovBrLogoIMg from '../../assets/images/govbrlogo.png';
...
import creace from "../../assets/images/logoCrea.png"
...
function SignInPage() {
  ...
  useEffect(() => {
    setValue('email', 'admin@s4S.com', { shouldDirty: true, shouldValidate: true });
        ...
        <div className="w-full max-w-320 sm:w-320 mx-auto sm:mx-0">
          ...
          >
            ...
            <div className="flex items-center mt-32 space-x-16">
              <button className="w-full flex items-center justify-center border-2 p-8">
                <p className='text-[#00509b] font-bold mr-4'>Acessar com o</p>
                <div>
                <img
                  src={GovBrLogoIMg}
                  width={60}
      ...
      >
        ...
        <div className="z-10 relative w-full max-w-2xl">
          <div className="text-7xl font-bold leading-none text-gray-100">
            <div className="mb-5">Bem vindo a s4SCREA-CE</div>
          ...
          <div className="mt-24 text-lg tracking-tight leading-6 text-gray-400">
            Sistema Informatizado do CREA-CE. <span className="font-bold text-white">Clique no botão Não tenho acesso! desta página para
            obter sua nova senha.</span> Fique atento e utilize as facilidades que o sistema oferece,
